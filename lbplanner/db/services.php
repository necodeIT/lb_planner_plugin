...
$functions = [
    'local_lbplanner_user_get_user' => [
        ...
        'description' => 'Returns current userdata',
        'type' => 'read',
    ...
    'local_lbplanner_user_get_all_users' => [
        ...
        'description' => 'Returns all users, optionally filtered by vintage',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_user_update_user' => [
        ...
        'description' => 'Update current user settings. null values or unset parameters are left unmodified',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_courses_get_my_courses' => [
        ...
        'description' => 'Returns courses visible to this user',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_courses_update_course' => [
        ...
        'description' => 'Update the user-specific data for a course',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_modules_get_module' => [
        ...
        'description' => 'Returns the data for a module',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_modules_get_all_modules' => [
        ...
        'description' => 'Returns all the modules for a user',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_modules_get_all_course_modules' => [
        ...
        'description' => 'Returns all modules belonging to a course',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_clear_plan' => [
        ...
        'description' => 'Clears your current plan',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_get_plan' => [
        ...
        'description' => 'Returns the plan of the current user',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_invite_user' => [
        ...
        'description' => 'Invite a user to the current user\'s plan',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_remove_user' => [
        ...
        'description' => 'Remove a user from your plan',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_update_plan' => [
        ...
        'description' => 'Update the plan details',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_leave_plan' => [
        ...
        'description' => 'Leave current plan. If no other user exists in the plan, the user can\'t leave',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_plan_delete_deadline' => [
        ...
        'description' => 'Deletes a deadline from your plan',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_plan_set_deadline' => [
        ...
        'description' => 'Set the deadline for a module',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_plan_get_invites' => [
        ...
        'description' => 'Returns all invites for this user',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_notifications_get_all_notifications' => [
        ...
        'description' => 'Returns all notifications for this user',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_slots_get_my_slots' => [
        ...
        'description' => 'Returns all slots the user can reserve, not including already-reserved ones',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_slots_get_student_slots' => [
        ...
        'description' => 'Returns all slots a supervisor can reserve for a user, not including already-reserved ones',
        'type' => 'read',
    ...
    'local_lbplanner_slots_get_supervisor_slots' => [
        ...
        'description' => 'Returns all slots belonging to the supervisor',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:teacher',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_slots_book_reservation' => [
        ...
        'description' => 'Books a reservation for the user. Will unbook any overlapping reservations the user may already have',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_slots_unbook_reservation' => [
        ...
        'description' => 'Tries to request unbooking a reservation',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    'local_lbplanner_slots_get_slot_reservations' => [
        ...
        'description' => 'Returns all reservations for a slot',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:teacher',
        'ajax' => true,
    ],
    'local_lbplanner_slots_get_my_reservations' => [
        ...
        'description' => 'Returns all reservations for this user',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:student',
        'ajax' => true,
    ],
    ...
    'local_lbplanner_slots_add_slot_supervisor' => [
        ...
        'description' => 'Adds a supervisor to a slot',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:slotmaster',
        'ajax' => true,
    ],
    'local_lbplanner_slots_remove_slot_supervisor' => [
        ...
        'description' => 'Removes a supervisor from a slot',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:slotmaster',
        'ajax' => true,
    ],
    'local_lbplanner_slots_add_slot_filter' => [
        ...
        'description' => 'Creates a new filter and adds it to a slot',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:slotmaster',
        'ajax' => true,
    ],
    'local_lbplanner_slots_delete_slot_filter' => [
        ...
        'description' => 'Delete a filter from a slot',
        'type' => 'write',
        'capabilities' => 'local/lb_planner:slotmaster',
        'ajax' => true,
    ],
    'local_lbplanner_slots_get_slot_filters' => [
        ...
        'description' => 'List all filters that apply to a slot',
        'type' => 'read',
        'capabilities' => 'local/lb_planner:slotmaster',
        'ajax' => true,
    ],
